...
-> Manage-items.jsp
-> AdminDAO.java
-> AdminBean.java (adminbean is the place where's the data submitted/collected or retrieved taken place, this file usually takes place(used) in the middle or the last part of the flow or when feature taken progress (this is why there i didn't insert adminbean on the flow that below this part).)
